...
export function Header({ theme, onToggleTheme, view, currentGenre, onBack, onShowHelp }: HeaderProps) {
  if (view === 'mode-select') {
    ...
    return (
      <header className="flex items-center justify-end py-3 px-4 gap-1">
        <a href="https://ko-fi.com/A0A21W2W51" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
          <img height="28" style={{ border: 0, height: 28 }} src="https://storage.ko-fi.com/cdn/kofi5.png?v=6" alt="Buy Me a Coffee at ko-fi.com" />
        </a>
        <button
