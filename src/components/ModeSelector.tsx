    ...
    <div className="min-h-[80vh] flex flex-col justify-center py-12">
      ...
      <footer className="text-center mt-16 px-4 space-y-1">
        ...
        <div className="flex justify-center items-center gap-3 mt-2">
          ...
          <a href="https://x.com/k_capa50367" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center justify-center w-8 h-8 bg-gray-700 hover:bg-gray-600 text-white rounded-full transition-colors"
            title="Follow on X"
          >
